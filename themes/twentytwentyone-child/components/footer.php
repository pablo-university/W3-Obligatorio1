			...
			<address class="d-none d-md-block">
				...
				<form action="">
					<div class="input-group my-3">
						<input type="text" class="form-control bg-transparent border-0 border-bottom border-secondary rounded-0 text-white-50" placeholder="Enter email for updates" aria-label="Recipient's username" aria-describedby="button-addon2">
						<button class="btn" type="button" id="button-addon2" aria-label="Button for reach out">
							<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#6c757d" class="bi bi-arrow-right-short" viewBox="0 0 16 16">
